...
public class MySqlAccess {
    ...
    public Connection getConnection() throws SQLException {
        ...
        return DriverManager.getConnection("jdbc:mysql://" + sqlConfig.getValue().get("Host") + ":" + sqlConfig.getValue().get("HostPort") + "/" + sqlConfig.getValue().get("Database"), sqlConfig.getValue().get("User"), sqlConfig.getValue().get("Password"));
    ...
    public void installBase() throws SQLException {
        try {
            ...
            System.out.printf("[EcoAPI] Database error " + String.valueOf(e));
        }
